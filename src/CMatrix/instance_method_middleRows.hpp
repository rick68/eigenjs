//
// CMatrix/instance_method_middleRows.hpp
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
...
#ifndef EIGENJS_CMATRIX_INSTANCE_METHOD_MIDDLEROWS_HPP
#define EIGENJS_CMATRIX_INSTANCE_METHOD_MIDDLEROWS_HPP

namespace EigenJS {

EIGENJS_INSTANCE_METHOD(CMatrix, middleRows,
{
  NanScope();
  ...
  if (args.Length() == 2) {
    if (args[0]->IsNumber() && args[1]->IsNumber()) {
      ...
      v8::Local<v8::Value> argv[] = {
          args.This()
        , NanNew<v8::Integer>(startRow)      /* startRow */
...
#endif  // EIGENJS_CMATRIX_INSTANCE_METHOD_MIDDLEROWS_HPP
