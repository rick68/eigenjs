//
// CRowVector/class_method_Constant.hpp
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
...
#ifndef EIGENJS_CROWVECTOR_CLASS_METHOD_CONSTANT_HPP
#define EIGENJS_CROWVECTOR_CLASS_METHOD_CONSTANT_HPP

#include "../common_macro.hpp"

namespace EigenJS {

EIGENJS_CLASS_METHOD(CRowVector, Constant,
{
  ...
  if ( args_length == 2 &&
    ...
    const typename T::value_type::Index& cols = args[0]->Int32Value();
...
#endif  // EIGENJS_CROWVECTOR_CLASS_METHOD_CONSTANT_HPP
