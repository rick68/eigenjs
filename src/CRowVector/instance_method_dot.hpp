//
// CRowVector/instance_method_dot.hpp
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
...
#ifndef EIGENJS_CROWVECTOR_INSTANCE_METHOD_DOT_HPP
#define EIGENJS_CROWVECTOR_INSTANCE_METHOD_DOT_HPP

namespace EigenJS {

EIGENJS_INSTANCE_METHOD(CRowVector, dot,
{
  NanScope();
  ...
  if (args.Length() == 1) {
    ...
    if (CMatrix::is_cmatrix(args[0])) {
      ...
      result = value.dot(rhs_cvector.transpose());
      ...
      result = value.dot(rhs_cvectorblock.transpose());
      ...
      result = value.dot(rhs_vector.transpose());
      ...
      result = value.dot(rhs_vectorblock.transpose());
      ...
      result = value.dot(rhs_rowvectorblock);
    } else if (true) {
      EIGENJS_THROW_ERROR_INVALID_ARGUMENT()
      NanReturnUndefined();
    }
...
#endif  // EIGENJS_CROWVECTOR_INSTANCE_METHOD_DOT_HPP
