//
// CVector/instance_method_dot.hpp
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
...
#ifndef EIGENJS_CVECTOR_INSTANCE_METHOD_DOT_HPP
#define EIGENJS_CVECTOR_INSTANCE_METHOD_DOT_HPP

namespace EigenJS {

EIGENJS_INSTANCE_METHOD(CVector, dot,
{
  NanScope();
  ...
  if (args.Length() == 1) {
    ...
    if (CMatrix::is_cmatrix(args[0])) {
      ...
      result = value.dot(rhs_crowvector.transpose());
      ...
      result = value.dot(rhs_cvectorblock);
      ...
      result = value.dot(rhs_crowvectorblock.transpose());
      ...
      result = value.dot(rhs_rowvector.transpose());
      ...
      result = value.dot(rhs_vectorblock);
      ...
      result = value.dot(rhs_rowvectorblock.transpose());
    } else if (true) {
      EIGENJS_THROW_ERROR_INVALID_ARGUMENT()
      NanReturnUndefined();
    }
...
#endif  // EIGENJS_CVECTOR_INSTANCE_METHOD_DOT_HPP
