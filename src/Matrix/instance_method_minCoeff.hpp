//
// Matrix/instance_method_minCoeff.hpp
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
...
#ifndef EIGENJS_MATRIX_INSTANCE_METHOD_MINCOEFF_HPP
#define EIGENJS_MATRIX_INSTANCE_METHOD_MINCOEFF_HPP

namespace EigenJS {

EIGENJS_INSTANCE_METHOD(Matrix, minCoeff,
{
  NanScope();
  ...
  if (args.Length() == 1) {
    ...
    if (args[0]->IsFunction()) {
      min = value.minCoeff(&rowId, &colId);
...
#endif  // EIGENJS_MATRIX_INSTANCE_METHOD_MINCOEFF_HPP
