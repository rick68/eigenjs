...
#define EIGENJS_COMMON_MATRIX_INSTANCE_METHOD_NORM_CONTEXT()                 \
  {                                                                          \
    const T* const& obj = node::ObjectWrap::Unwrap< T >( args.This() );      \
    const typename T::value_type& value = **obj;                             \
                                                                             \
...
#define EIGENJS_COMMON_MATRIX_INSTANCE_METHOD_ANY_CONTEXT()                  \
  {                                                                          \
    const T* const& obj = node::ObjectWrap::Unwrap< T >( args.This() );      \
    const typename T::value_type& value = **obj;                             \
                                                                             \
    NanScope();                                                              \
    NanReturnValue( NanNew< v8::Boolean >( value.any() ) );                  \
  }                                                                          \
  /**/
...
#define EIGENJS_COMMON_MATRIX_INSTANCE_METHOD_NONZEROS_CONTEXT()             \
  {                                                                          \
    const T* const& obj = node::ObjectWrap::Unwrap< T >( args.This() );      \
    const typename T::value_type& value = **obj;                             \
                                                                             \
    NanScope();                                                              \
    NanReturnValue( NanNew< v8::Integer >( value.nonZeros() ) );             \
  }                                                                          \
  /**/
...
#define EIGENJS_COMMON_MATRIX_INSTANCE_METHOD_ALLFINITE_CONTEXT()            \
  {                                                                          \
    ...
    const typename T::value_type& value = **obj;                             \
                                                                             \
    NanScope();                                                              \
    NanReturnValue( NanNew< v8::Boolean >( value.allFinite() ) );            \
  }                                                                          \
  /**/
